...
class BoatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create boat" do
    assert_difference("Boat.count") do
      post boats_url, params: { boat: { length: @boat.length, name: @boat.name, width: @boat.width } }
    end
  ...
  test "should update boat" do
    patch boat_url(@boat), params: { boat: { length: @boat.length, name: @boat.name, width: @boat.width } }
